...
class KnickKnackerIO {
  ...
  */
  ...
  /**
  * Reads users.csv and returns user with given id.
  * @param id Unsigned int value of id for user.
  * @return User with given id.
  */
  virtual User* getUserByID(unsigned int id);
  /**
  * Reads commens.csv and returns comments with given issue id.
  * @param i_id Unsigned int value of issue id for comment.
  * @return comments with specific issueID.
  */
  virtual std::vector<Comment*> getCommentsByIID(unsigned int i_id);
  /**
